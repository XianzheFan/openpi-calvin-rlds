...
_CONFIGS = [
    ...
    TrainConfig(
        ...
        data=LeRobotCalvinDataConfig(
            repo_id="/mnt/afs/fanxianzhe/InternData-Calvin_ABC",
            base_config=DataConfig(prompt_from_task=True),
        ),
        batch_size=256,
        weight_loader=weight_loaders.CheckpointWeightLoader("/mnt/afs/fanxianzhe/pi0-graspsim/openpi_ckpts/pi05_base/params"),
